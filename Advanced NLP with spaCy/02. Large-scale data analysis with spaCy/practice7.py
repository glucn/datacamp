...
#
# The nlp and a doc have already been created for you. If you get stuck, try printing the tokens in the doc to see
# how the text will be split and adjust the pattern so that each dictionary represents one token.
#
